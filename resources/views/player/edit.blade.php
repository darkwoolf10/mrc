...
@section('content')
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" id="name" placeholder="{{$player->name}}" value="{{$player->name}}">
        </div>
        <div class="form-group">
            <label for="player_surname"><h4>Player surnamer</h4></label>
            <input type="text" name="surname" class="form-control" id="surname" placeholder="{{$player->surname}}" value="{{$player->surname}}">
        </div>
